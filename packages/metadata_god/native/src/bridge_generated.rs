    ...
    impl Wire2Api<Metadata> for JsValue {
        fn wire2api(self) -> Metadata {
            ...
            Metadata {
                ...
                replay_gain_album_gain: self_.get(13).wire2api(),
                replay_gain_album_peak: self_.get(14).wire2api(),
                replay_gain_track_gain: self_.get(15).wire2api(),
                replay_gain_track_peak: self_.get(16).wire2api(),
            }
        }
    }
